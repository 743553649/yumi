...
:deep(.log-time) { color: #10B981; }
:deep(.log-info) { color: #60A5FA; font-weight: bold; }
:deep(.log-warn) { color: #FBBF24; font-weight: bold; }
:deep(.log-error) { color: #F87171; font-weight: bold; }
:deep(.log-tag) { color: #C084FC; }
</style>
