...
mod tests {
    ...
    fn test_format_missing_key() {
        assert_eq!(
            format_missing_key("touch-boost-channel-disconnected"),
            "Touch Boost Channel Disconnected"
        );
        assert_eq!(
            format_missing_key("scheduler_module_started"),
            "Scheduler Module Started"
        );
